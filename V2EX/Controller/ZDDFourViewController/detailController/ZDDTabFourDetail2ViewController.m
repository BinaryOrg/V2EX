...
- (void)mf_loadMoreDataWithId:(NSInteger)key {
    ...
    [MFNETWROK get:[NSString stringWithFormat:@"https://api.godzzzzz.club/api/v2ex/getAvatar?id=%@", @(key)] params:nil success:^(id result, NSInteger statusCode, NSURLSessionDataTask *task) {
...
- (void)mf_refreshData {
    [MFNETWROK get:@"https://api.godzzzzz.club/api/v2ex/getAvatar?id=0" params:nil success:^(id result, NSInteger statusCode, NSURLSessionDataTask *task) {
