//
//  ZDDTabFourDetail2ViewController.m
//  V2EX
//
...
#import "ZDDTX2TableViewCell.h"
#import "ZDDTX3TableViewCell.h"
#import "ZDDTX4TableViewCell.h"
#import "UIColor+ZDDColor.h"
#import "Topics.h"
#import "Pagination.h"
#import <ESPictureBrowser/ESPictureBrowser.h>
@interface ZDDTabFourDetail2ViewController ()
<
UITableViewDelegate,
...
@implementation ZDDTabFourDetail2ViewController
...
- (void)mf_loadMoreDataWithId:(NSInteger)key {
    ...
    [MFNETWROK get:[NSString stringWithFormat:@"http://notch.qdaily.com/api/v2/avatar_topics?last_key=%@&platform=ios", @(key)] params:nil success:^(id result, NSInteger statusCode, NSURLSessionDataTask *task) {
...
- (void)mf_refreshData {
    [MFNETWROK get:@"http://notch.qdaily.com/api/v2/avatar_topics?last_key=0&platform=ios" params:nil success:^(id result, NSInteger statusCode, NSURLSessionDataTask *task) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (model.pictures.count == 1) {
        ZDDTXTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"bz1"];
        if (!cell) {
            cell = [[ZDDTXTableViewCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"bz1"];
        }
        [self configCell1:cell withModel:model];
        return cell;
    }else if (model.pictures.count == 2) {
        ZDDTX2TableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"bz2"];
        if (!cell) {
            cell = [[ZDDTX2TableViewCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"bz2"];
        }
        [self configCell2:cell withModel:model];
        return cell;
    }else if (model.pictures.count == 3) {
        ZDDTX3TableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"bz3"];
        if (!cell) {
            cell = [[ZDDTX3TableViewCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"bz3"];
        }
        [self configCell3:cell withModel:model];
        return cell;
    }else {
        ZDDTX4TableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"bz4"];
        if (!cell) {
            cell = [[ZDDTX4TableViewCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"bz4"];
        }
...
- (void)configCell1:(ZDDTXTableViewCell *)cell withModel:(Topics *)model {
...
- (void)configCell2:(ZDDTX2TableViewCell *)cell withModel:(Topics *)model {
...
- (void)configCell3:(ZDDTX3TableViewCell *)cell withModel:(Topics *)model {
    [cell.imageView1 yy_setImageWithURL:[NSURL URLWithString:model.pictures.firstObject.pic_info.medium] options:YYWebImageOptionProgressiveBlur|YYWebImageOptionSetImageWithFadeAnimation];
...
- (void)configCell4:(ZDDTX4TableViewCell *)cell withModel:(Topics *)model {
    [cell.imageView1 yy_setImageWithURL:[NSURL URLWithString:model.pictures.firstObject.pic_info.medium] options:YYWebImageOptionProgressiveBlur|YYWebImageOptionSetImageWithFadeAnimation];
    [cell.imageView2 yy_setImageWithURL:[NSURL URLWithString:model.pictures[1].pic_info.medium] options:YYWebImageOptionProgressiveBlur|YYWebImageOptionSetImageWithFadeAnimation];
...
- (UIImage *)pictureView:(ESPictureBrowser *)pictureBrowser defaultImageForIndex:(NSInteger)index {
    ...
    if (count == 1) {
        ZDDTXTableViewCell *cell = [self.tableView cellForRowAtIndexPath:indexPath];
        return cell.imageView1.image;
    }
    else if (count == 2) {
        ZDDTX2TableViewCell *cell = [self.tableView cellForRowAtIndexPath:indexPath];
        if (index) {
        ...
        ZDDTX3TableViewCell *cell = [self.tableView cellForRowAtIndexPath:indexPath];
        if (index == 1) {
            return cell.imageView2.image;
        }
        else if (index == 2) {
        ...
        ZDDTX4TableViewCell *cell = [self.tableView cellForRowAtIndexPath:indexPath];
        if (index == 1) {
            return cell.imageView2.image;
        }
        else if (index == 2) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (model.pictures.count == 1 || model.pictures.count == 2) {
        return 150 + ((ScreenWidth - 80)/2);
    }
    return 160 + (((ScreenWidth - 80)/2))*2;
}
