...
#import "GODDefine.h"
@implementation ZDDTX4TableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.imageView4 = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.imageView3.frame) + 20, CGRectGetMaxY(self.imageView1.frame) + 10, (ScreenWidth - 80)/2, ((ScreenWidth - 80)/2))];
